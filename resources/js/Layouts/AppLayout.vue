                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink v-if="permissions.includes('blog view')" :href="route('admin.blog')" :active="route().current('admin.blog')">
                                    Blog
                                </NavLink>

                                <NavLink v-if="permissions.includes('news view')" :href="route('admin.news')" :active="route().current('admin.news')">
                                    News
                                </NavLink>

                                <NavLink :href="route('admin.roles')" :active="route().current('admin.roles')">
                                    Roles
                                </NavLink>
                            </div>
                        </div>
